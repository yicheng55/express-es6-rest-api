...
// import { URL } from 'url';
// global.userConfig = require("./config/user.config.js");
// console.log(global.userConfig);
import {service} from './config/user.def.js';
// 匯入json file 方式1.
import {userconfig as userConfig} from './config/user.config.js';
// Test code global.
// global.studentName = 'Kyle';
// console.log(global);

// Test import .json file.
// import testConfig from './config/test.config.json' assert { type: 'json' };
// import testConfig from './config/test.config.json';
// console.log(testConfig);

import indexRouter from './routes/index.js';
// eslint-disable-next-line no-unused-vars
import productRouter from './routes/product.routes.js'; // Import routes for "catalog" area of site
// const productRouter = require('./routes/product.routes.js');  //Import routes for "product" area of site
// const locationRouter = require('./routes/location.routes.js');  //Import routes for "product" area of site
// // const flds_bindRouter = require('./routes/flds_bind.routes.js');  //Import routes for "product" area of site
// const flds_userRouter = require('./routes/flds_user.routes.js');  //Import routes for "product" area of site
import flds_userRouter from './routes/flds_user.routes.js';

import cookieParser from 'cookie-parser';
console.log(userConfig);
// Test code.
// import {service, config02}  from './config/user.config01.js';
// console.log(service);
...
// import userConfig from './config/user.config.json' assert {type: 'json'};
// console.log(userConfig);
